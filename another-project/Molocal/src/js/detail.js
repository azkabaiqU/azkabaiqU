...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const cardsData = [
            ...
            <a href="/src/html/detail.html?id=7" class="">
             ...
             <a href="/src/html/detail.html?id=9" class="">
                            ...
                            <div class="mt-[12px]">
                                <div class="flex items-center pjs-m w-full">
                                    <div class="w-[40px] h-[40px]  overflow-hidden rounded-full mr-[12px]">
                                        <img class="object-cover  w-full h-full" src="https://resize.indiatvnews.com/en/resize/newbucket/1080_-/2024/01/bloodhounds-1704786617.webp" alt="img">
                                    </div>
                                    <h1 class=" sm:text-[24px] text-[20px] pjs-r text-black">Lee Sang-yi</h1>
                                    <p class="pjs-l text-[16px] text-black/10 px-[12px] ">|</p>
        ...
        // 9
        {
            ...
            pfp: 'https://resize.indiatvnews.com/en/resize/newbucket/1080_-/2024/01/bloodhounds-1704786617.webp',
            nama: 'Lee Sang-yi',
            ...
            <a href="/src/html/detail.html?id=10" class="">
             ...
             <a href="/src/html/detail.html?id=12" class="">
                            ...
                            <div class="mt-[12px]">
                                <div class="flex items-center pjs-m w-full">
                                    <div class="w-[40px] h-[40px]  overflow-hidden rounded-full mr-[12px]">
                                        <img class="object-cover  w-full h-full" src="https://m.media-amazon.com/images/M/MV5BOGQ0NTk5MTEtMTAxMS00NGEwLTk4MDItNTRiNTExYTZlYWVhXkEyXkFqcGc@._V1_.jpg" alt="img">
                                    </div>
                                    <h1 class=" sm:text-[24px] text-[20px] pjs-r text-black">Bong gil</h1>
                                    <p class="pjs-l text-[16px] text-black/10 px-[12px] ">|</p>
                                    <p class="textGray  text-[16px] text-black/40 pjs-l">1 jam yang lalu</p>
                                </div>
        ...
        // 12
        {
            ...
            pfp: 'https://m.media-amazon.com/images/M/MV5BOGQ0NTk5MTEtMTAxMS00NGEwLTk4MDItNTRiNTExYTZlYWVhXkEyXkFqcGc@._V1_.jpg',
            nama: 'Bong gil',
            dibuat: '6 September 2024',
            jam: '03:21 WIB',
